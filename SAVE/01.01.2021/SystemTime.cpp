...
int initSystemTime() {
	...
	int errCod = 0;
	bool setClock = true;  //указывает устанавливать часы по времени компил€ции скетча при каждой его загрузке, или перезагрузке ардуино, поэтому по умолчанию false
