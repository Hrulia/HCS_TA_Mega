...
public:
  ...
  //void showDots(uint8_t dots, uint8_t* digits); //msn

  // моя функция по выводу значений флоат с округлением после запятой 0-целый, 1-один знак и т.д.)
  void showNumberMsn(float num, uint8_t rounding=1);
