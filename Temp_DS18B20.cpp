...
/*Массив значений температур датчиков
[10]-t11 верх ТА*/
...
const uint8_t  ds18b20_address[NUMBER_OF_DS18B20][8] = {
	...
	{ 0x28, 0xFF, 0xCA, 0xA7, 0x60, 0x18, 0x02, 0x7B },  // 2- t3, Температура в Большой спальне
	...
	{ 0x28, 0x97, 0x55, 0xC0, 0x04, 0x00, 0x00, 0xCA },  // 15-t16, обратка ЭК 0x28, 0x97, 0x55, 0xC0, 0x04, 0x00, 0x00, 0xCA 
...
//	{ 0x28, 0xFF, 0xA8, 0xA5, 0x60, 0x18, 0x02, 0xEE },  // 2- t3, Температура в Большой спальне
...
//int getTemperaturDS18B20(OneWire& ds18b20)
{
	...
	*/	
	...
	if (LOG) { Serial.print("\nstart (getTemperaturDS18B20) "); Serial.println(globalParameters.g_systemDateTime.timestamp(globalParameters.g_systemDateTime.TIMESTAMP_TIME)); }
